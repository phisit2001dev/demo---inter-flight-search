...
import { AccessibleAirportTableComponent } from '../components/accessible-airport-table/accessible-airport-table.component';
...
import { AccessibleAirportDialogComponent } from '../components/accessible-airport-dialog/accessible-airport-dialog.component';
...
@NgModule({
  declarations: [AccessibleAirportTableComponent, AccessibleAirportDialogComponent],
  imports: [
    CommonModule,
  ...
  exports: [
    AccessibleAirportTableComponent,
    AccessibleAirportDialogComponent
  ]
})
export class AccessibleAirportTableModule { }
