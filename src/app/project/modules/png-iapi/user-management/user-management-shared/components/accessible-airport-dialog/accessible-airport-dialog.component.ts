...
@Component({
  selector: 'app-accessible-airport-dialog',
  templateUrl: './accessible-airport-dialog.component.html',
  styleUrls: ['./accessible-airport-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [FormBuilder, ManualDetectionService, MAT_SELECT_SCROLL_STRATEGY_PROVIDER]
})
export class AccessibleAirportDialogComponent
  ...
  implements OnInit, OnDestroy {
    ...
    form: FormGroup;
    dataSource: MatTableDataSource<any> = new MatTableDataSource<PermissionAirportSearch>([]);
    ...
    constructor(
      ...
      private dialogRef: MatDialogRef<AccessibleAirportDialogComponent>,
    ...
    choose() {
      ...
      let nodes: PermissionAirportSearch[] = [];
